...
import './scss/sub7AdminSignUp.scss'

export default function Sub7AdminSignUp1Component(){
    ...
    React.useEffect(()=>{
        axios({
            url:'http://answotlr12.dothome.co.kr/kakao/kakao_admin_id_check.php',
            method:'GET'
        })
        .then((res)=>{
            if(res.status===200){
    ...
    const onSubmitForm=(e)=>{
        ...
        // }
            ...
            axios({
                url: 'http://answotlr12.dothome.co.kr/kakao/kakao_admin_insert_table.php',
                method: 'POST',
                data: formData  
            })
            .then((res)=>{
